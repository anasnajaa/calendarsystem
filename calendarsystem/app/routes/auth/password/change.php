<?php
$app->get('/change-password', $authinticated(), function () use($app) {
  $app->render('auth/password/change.php');
})->name('password.change');

$app->post('/change-password', $authinticated(), function() use ($app) {
  ...
  if ($valid->passes()) {
    ...
    $user->update([
      ...
      $app->flash('passwordupdated', 'Your password has been changed.');
